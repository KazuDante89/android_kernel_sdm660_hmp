...
#################
# Clean out folder
rm -rf '/media/system/root1/android_kernel_sdm660_hmp/out'
# Set defaults
cd "/media/system/root1/android_kernel_sdm660_hmp"
wd=$(pwd)
out=$wd/out
BUILD="/media/system/root1/android_kernel_sdm660_hmp"
...
# mounting to browser
cd "/media/system/root1/android_kernel_sdm660_hmp/out/arch/arm64/boot"
